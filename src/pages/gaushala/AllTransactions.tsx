...
const DUMMY_CONTRIBUTIONS: Contribution[] = [
  {
    id: '1',
    externalId: 'TXN-2025-001',
    contributionDate: '2025-10-25',
    weightKg: 125.5,
    ratePerKg: 8.5,
    totalAmount: 1066.75,
    paymentMethod: 'UPI',
    ...
    notes: 'High quality dung collected in good condition',
    operatorUserId: 'op-001',
  ...
  {
    id: '2',
    externalId: 'TXN-2025-002',
    contributionDate: '2025-10-24',
    weightKg: 98.75,
    ratePerKg: 7.5,
    totalAmount: 740.63,
    paymentMethod: 'CASH',
    ...
    workflowStatus: 'COMPLETED',
    validationStatus: 'ASSIGNED',
    notes: 'Standard quality collection',
    operatorUserId: 'op-002',
    operatorName: 'Priya Singh',
    operatorPhone: '+919765432109',
    farmer: {
      name: 'Gaushala Gurugram',
      externalId: 'G-102',
      phone: '+919988776655'
    }
  },
  {
    id: '3',
    externalId: 'TXN-2025-003',
    contributionDate: '2025-10-23',
    weightKg: 156.2,
    ratePerKg: 8.5,
    totalAmount: 1327.70,
    paymentMethod: 'NEFT',
    ...
    moistureContent: 7.8,
    gpsLatitude: 28.4089,
    gpsLongitude: 77.3178,
    workflowStatus: 'PROCESSING',
    validationStatus: 'ASSIGNED',
    notes: 'Premium quality, excellent moisture content',
    operatorUserId: 'op-003',
    operatorName: 'Amit Patel',
    operatorPhone: '+919654321098',
    farmer: {
      name: 'Gaushala Noida',
      externalId: 'G-103',
      phone: '+919988776655'
  ...
  {
    id: '4',
    externalId: 'TXN-2025-004',
    contributionDate: '2025-10-22',
    weightKg: 82.4,
    ratePerKg: 6.0,
    totalAmount: 494.40,
    paymentMethod: 'AEPS',
    ...
    notes: 'Basic quality, needs drying',
    operatorUserId: 'op-001',
    operatorName: 'Rajesh Kumar',
    operatorPhone: '+919876543210',
    farmer: {
      name: 'Gaushala Faridabad',
      externalId: 'G-104',
      phone: '+919988776655'
    }
  },
  {
    id: '5',
    externalId: 'TXN-2025-005',
    contributionDate: '2025-10-21',
    weightKg: 145.8,
    ratePerKg: 8.0,
    totalAmount: 1166.40,
    paymentMethod: 'UPI',
    ...
    workflowStatus: 'COMPLETED',
    validationStatus: 'ASSIGNED',
    notes: 'Good quality collection from morning shift',
    operatorUserId: 'op-002',
    operatorName: 'Priya Singh',
    operatorPhone: '+919765432109',
    farmer: {
      name: 'Gaushala Ghaziabad',
      externalId: 'G-105',
      phone: '+919988776655'
    }
  },
  {
    id: '6',
    externalId: 'TXN-2025-006',
    contributionDate: '2025-10-20',
    weightKg: 167.3,
    ratePerKg: 8.5,
    totalAmount: 1422.05,
    paymentMethod: 'NEFT',
    ...
    workflowStatus: 'COMPLETED',
    validationStatus: 'ASSIGNED',
    notes: 'Excellent quality premium dung collection',
    operatorUserId: 'op-003',
    operatorName: 'Amit Patel',
    operatorPhone: '+919654321098',
    farmer: {
      name: 'Gaushala Meerut',
      externalId: 'G-106',
      phone: '+919988776655'
    }
  },
  {
    id: '7',
    externalId: 'TXN-2025-007',
    contributionDate: '2025-10-19',
    weightKg: 103.5,
    ratePerKg: 7.0,
    totalAmount: 724.50,
    paymentMethod: 'CASH',
    ...
    workflowStatus: 'COMPLETED',
    validationStatus: 'ASSIGNED',
    notes: 'Standard quality collection completed',
    operatorUserId: 'op-001',
    operatorName: 'Rajesh Kumar',
    operatorPhone: '+919876543210',
    farmer: {
      name: 'Gaushala Indirapuram',
      externalId: 'G-107',
      phone: '+919988776655'
    }
  },
  {
    id: '8',
    externalId: 'TXN-2025-008',
    contributionDate: '2025-10-18',
    weightKg: 91.2,
    ratePerKg: 7.5,
    totalAmount: 684.00,
    paymentMethod: 'UPI',
    ...
    workflowStatus: 'PENDING',
    validationStatus: 'PENDING',
    notes: 'Payment failed - retry pending',
    operatorUserId: 'op-002',
    operatorName: 'Priya Singh',
    operatorPhone: '+919765432109',
    farmer: {
      name: 'Gaushala Vaishali',
      externalId: 'G-108',
      phone: '+919988776655'
    }
  }
...
export default function AllTransactions({ onClose }: Props) {
  ...
  const loadAllContributions = async () => {
    try {
      ...
      // Fetch dung collections for logged-in gaushala using /my-gaushala endpoint
      const response = await biogasService.getMyGaushalaCollections(
        0, // page
